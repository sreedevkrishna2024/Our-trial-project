...
const QUICK_PROMPTS = [
  { 
    icon: Lightbulb, 
    text: 'Generate a story idea', 
    prompt: 'I need help generating a creative story idea. Can you suggest something unique and engaging?' 
  },
  { 
    icon: BookOpen, 
    text: 'Create a character', 
    prompt: 'Help me develop a compelling character for my story. I want someone memorable and realistic.' 
  },
  { 
    icon: Target, 
    text: 'Write dialogue', 
    prompt: 'I need help writing natural dialogue that reveals character and advances the plot.' 
  },
  { 
    icon: Users, 
    text: 'Develop a plot', 
    prompt: 'Can you help me structure my story plot? I want to make sure it has good pacing and conflict.' 
  },
  { 
    icon: PenTool, 
    text: 'Build a world', 
    prompt: 'I need help world-building for my story. How do I create a rich, immersive setting?' 
  },
  { 
    icon: Zap, 
    text: 'Writing advice', 
    prompt: 'I\'m struggling with my writing. Can you give me some general advice to improve?' 
  }
]
...
export function ChatBotNew() {
  ...
  const sendMessage = async (messageText?: string) => {
    ...
    // **CRITICAL: Direct Gemini API Integration with Writing Context**
    const systemMessage = "You are an AI creative writing assistant. Your purpose is to help users with story ideas, character development, plot points, dialogue writing, world-building, and general writing advice. Provide concise, relevant, and actionable responses from this perspective. Do not answer questions that are unrelated to creative writing. Stay focused on helping users improve their writing craft."
    ...
    const fullPrompt = `${systemMessage}\n\nUser's question: "${text}"\n\n${recentMessages ? `Recent conversation context:\n${recentMessages}\n\n` : ''}Please provide a helpful, specific response about creative writing.`
