      ...
      >
        ...
        <div className="mt-8 text-center">
          <p className="text-neutral-600">
            ...
            <Link href="/auth/signup" className="text-primary-600 hover:text-primary-800 font-semibold transition-colors hover:underline">
              Create one now
            </Link>
          </p>
        </div>

        <div className="mt-6 p-6 bg-gradient-to-r from-primary-50 to-secondary-50 rounded-xl border border-primary-200">
          <div className="text-center">
            <h3 className="text-sm font-bold text-primary-800 mb-3">Try the Demo Account</h3>
